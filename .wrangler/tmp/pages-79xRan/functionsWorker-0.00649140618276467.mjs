...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    const now = Date.now();
    const coherenceHours = Math.floor((now - birthTime) / (1e3 * 60 * 60));
    return new Response(JSON.stringify({
...
// ../.wrangler/tmp/bundle-SnSPg0/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-SnSPg0/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.00649140618276467.mjs.map
