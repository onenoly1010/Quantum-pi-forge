...
run_claim "reviewer-onboarding-boundary" "docs/REVIEWER_ONBOARDING.md" "(personal_sign|eth_sign|eth_sendTransaction|sendTransaction|wallet_requestPermissions|private key|seed phrase)" "Reviewer onboarding does not instruct wallet signing, transaction sending, or secret exposure"
