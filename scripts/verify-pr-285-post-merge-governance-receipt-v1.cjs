...
const docPath = "docs/governance/PR_285_POST_MERGE_GOVERNANCE_RECEIPT_V1.md";
const receiptPath = "receipts/governance/pr-285-post-merge-governance-receipt-v1.json";
function fail(message) { console.error("FAIL pr-285-post-merge-governance-receipt-v1: " + message); process.exit(1); }
...
if (receipt.artifact !== "pr-285-post-merge-governance-receipt-v1") fail("artifact mismatch");
if (receipt.pr !== 285) fail("PR mismatch");
if (receipt.merged_artifact !== "v2-funder-outreach-manifest-v1") fail("merged artifact mismatch");
...
console.log("PASS pr-285-post-merge-governance-receipt-v1");
