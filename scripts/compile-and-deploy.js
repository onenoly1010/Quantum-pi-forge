...
async function main() {
  console.log("🔨 Compiling OINIO.sol contract...");
  
  // Read contract source
  const source = fs.readFileSync("./src/OINIO.sol", "utf8");
  ...
  const contract = output.contracts["OINIO.sol"].OINIO;
  ...
  const provider = new ethers.JsonRpcProvider("https://evmrpc.0g.ai", 16661);
