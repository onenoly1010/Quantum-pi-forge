...
| 0G protocol integration | `0gskills.com/ship` before coding and linked skills as needed | `docs.0g.ai` for chain IDs, RPCs, addresses, and parameters | Guarded | Required for any production change |
