...
|---|---|---:|---|
| Reviewer entry point | `README.md` | SEALED | Main orientation file for external reviewers. |
| Verification docs | `docs/VERIFICATION.md` | SEALED | Baseline/proof references. |
...
flowchart TD
    ...
    B --> C[VERIFICATION.md]
    B --> D[EVIDENCE.md]
    D --> E[Canonical evidence verifier]
    D --> F[Issue #100]
    D --> G[Open PRs]
