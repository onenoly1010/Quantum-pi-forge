...
HUMAN: conversations → one painful task → receipt #001
LOCKS: held
```
...
## Phase 2 — Pick **ONE** painful task

Do **not** show the whole ecosystem.
...
```text
"I gave it a problem and it saved me time."
```

One task. One session. One measurement.
...
## Phase 4 — Let communities **pull** (only after proof)

| Before receipts | After 3–5 receipts |
| --- | --- |
| “We built something. Want to try it?” | “Five people used this workflow and reported saving time. We are opening a small pilot group.” |

Proof changes the conversation. Do not reverse the order.

---

## Trust loop order (do not invert)
...
| Frozen | Active |
| --- | --- |
| New features for their own sake | 10 candidate conversations |
| Architecture expansion | One painful task per pilot |
| More verification re-litigation | Seal receipt #001 |
| Token / mint / LP activation | Listen and capture evidence |
| Community announcement as strategy | Quiet invites → utility tests |
