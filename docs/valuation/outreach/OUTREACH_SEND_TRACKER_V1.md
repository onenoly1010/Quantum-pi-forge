...
|---|---|---|---|---|---|
| **Round 1 Slot A — independent peer** | Verification (8.5) | Any non-maintainer DM/email | **BLOCKED_SECRET_ROTATION** | Complete SECRET_ROTATION_WORKSHEET_V1.md then paste Slot A | Packet: docs/community/ROUND1_REVIEWER_SHARE_PACKET_V1.md |
