...
|---|---|---|---|---|---|
| **Round 1 Slot A — independent peer** | Verification (8.5) | Any non-maintainer DM/email | **BLOCKED_SECRET_ROTATION** | Complete docs/security/SECRET_ROTATION_WORKSHEET_V1.md then paste Slot A | Packet: docs/community/ROUND1_REVIEWER_SHARE_PACKET_V1.md |
| **Round 1 Slot B — security form** | Verification (8.5) | https://www.openzeppelin.com/request | **BLOCKED_SECRET_ROTATION** | Complete secret rotation then paste Slot B | Alt: trailofbits.com/contact · not a paid audit ask |
| **Round 1 Slot C — 0G ecosystem peer** | Verification (8.5) | https://phala.com/contact or peer DM | **BLOCKED_SECRET_ROTATION** | Complete secret rotation then paste Slot C | Points at #verify-now + #636 only |
