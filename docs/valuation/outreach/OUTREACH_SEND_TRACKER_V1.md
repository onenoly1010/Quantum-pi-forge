...
|---|---|---|---|---|---|
| **Round 1 Slot A — independent peer** | Verification (8.5) | Any non-maintainer DM/email | **READY_TO_SEND** | Human paste Slot A | Packet: docs/community/ROUND1_REVIEWER_SHARE_PACKET_V1.md · secrets 7/7 revoked |
